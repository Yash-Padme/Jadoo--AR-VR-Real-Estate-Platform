...
import lec from '../assets/lec.jpeg'
...
function Tenantcard1() {
  ...
  return (
    <div className='w-[98vw] bg-tertiary flex justify-center py-8 mx-auto'>
        ...
        <div className='xl:w-58% w-90% flex flex-col justify-start items-start xl:justify-start gap-4'>
          ...
          <div className="flex bg-gray-200 p-2 justify-between rounded-md w-full lg:flex-row flex-col">
            <div className="flex items-center">
              <img src={logo1} alt="" />
              <strong className="md:ml-2">Plot Area:</strong>&nbsp;190 sq. ft.
            </div>
            <div className="flex items-center">
              <img src={logo} alt="" />
          ...
          <p><strong>Address:</strong> Hazira, Gwalior</p>
